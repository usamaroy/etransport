            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                // $fun->redirect_dash($user->user_role);
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                             <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?=base_url('assets/data_image/').$user->image;?>" alt="user" class="rounded-circle" width="50" height="50"></a>
